...
namespace Reloader.Core.Tests.EditMode
{
    public class WeaponRuntimeStateTests
    {
        ...
        {
            var state = new WeaponRuntimeState("weapon-kar98k", magazineCapacity: 5, fireIntervalSeconds: 0.2f, magazineCount: 2, reserveCount: 10, chamberLoaded: true);
        ...
        {
            var state = new WeaponRuntimeState("weapon-kar98k", magazineCapacity: 5, fireIntervalSeconds: 0.2f, magazineCount: 0, reserveCount: 10, chamberLoaded: false);
        ...
        {
            var state = new WeaponRuntimeState("weapon-kar98k", magazineCapacity: 5, fireIntervalSeconds: 0.2f, magazineCount: 2, reserveCount: 9, chamberLoaded: true);
        ...
        {
            var state = new WeaponRuntimeState("weapon-kar98k", magazineCapacity: 5, fireIntervalSeconds: 0.2f, magazineCount: 0, reserveCount: 5, chamberLoaded: false);
        ...
        public void Registry_TryGetWeaponDefinition_ResolvesByItemId()
        {
            ...
            definition.SetRuntimeValuesForTests("weapon-kar98k", "Rifle", 5, 0.2f, 120f, 1f, 30f, 200f);
            registry.SetDefinitionsForTests(new[] { definition });

            var resolved = registry.TryGetWeaponDefinition("weapon-kar98k", out var found);
        ...
        {
            var state = new WeaponRuntimeState("weapon-kar98k", magazineCapacity: 5, fireIntervalSeconds: 0.2f, magazineCount: 2, reserveCount: 0, chamberLoaded: true);
        ...
        {
            var state = new WeaponRuntimeState("weapon-kar98k", magazineCapacity: 5, fireIntervalSeconds: 0.2f, magazineCount: 0, reserveCount: 3, chamberLoaded: false);
