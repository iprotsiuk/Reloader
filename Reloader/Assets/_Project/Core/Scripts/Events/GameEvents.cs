...
namespace Reloader.Core.Events
{
    public static class GameEvents
    {
        ...
        public static void RaiseWeaponEquipStarted(string itemId) => OnWeaponEquipStarted?.Invoke(itemId);
        public static void RaiseWeaponEquipped(string itemId) => OnWeaponEquipped?.Invoke(itemId);
        public static void RaiseWeaponUnequipStarted(string itemId) => OnWeaponUnequipStarted?.Invoke(itemId);
        ...
        public static void RaiseWeaponReloadStarted(string itemId) => OnWeaponReloadStarted?.Invoke(itemId);
        public static void RaiseWeaponReloadCancelled(string itemId, WeaponReloadCancelReason reason) => OnWeaponReloadCancelled?.Invoke(itemId, reason);
