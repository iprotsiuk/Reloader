...
namespace MCPForUnity.Editor.Services
{
    ...
    public class PackageUpdateService : IPackageUpdateService
    {
        ...
        protected virtual string FetchLatestVersionFromGitHub(string branch)
        {
            try
            {
                ...
                string packageJsonUrl = string.Equals(branch, "beta", StringComparison.OrdinalIgnoreCase)
                    ? BetaPackageJsonUrl
                    : MainPackageJsonUrl;
                string jsonContent = DownloadStringWithTimeout(packageJsonUrl, "Unity-MCPForUnity-UpdateChecker");
        ...
        protected virtual string FetchLatestVersionFromAssetStoreJson()
        {
            try
            {
                string jsonContent = DownloadStringWithTimeout(AssetStoreVersionUrl, "Unity-MCPForUnity-AssetStoreUpdateChecker");
        ...
        private static string DownloadStringWithTimeout(string url, string userAgent)
        {
